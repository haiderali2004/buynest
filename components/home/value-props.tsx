import { Truck, RotateCcw, ShieldCheck, GraduationCap } from "lucide-react";
...
const VALUE_PROPS = [
  ...
  { icon: GraduationCap, label: "Loved by schools & makers" },
];

function ValueProps() {
  return (
    <Reveal as="section" className="border-b border-border bg-paper">
